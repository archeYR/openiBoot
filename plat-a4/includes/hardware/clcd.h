...
#define DISPLAY_PIPE0	0x89000000
#define DISPLAY_PIPE1	0x89100000
#define CLCD			0x89200000
#define RGBOUT			0x89600000

#if !defined(CONFIG_ATV_2G)
#define DISPLAY_PIPE	DISPLAY_PIPE0
#else
#define DISPLAY_PIPE	DISPLAY_PIPE1
#endif
#if defined(CONFIG_IPHONE_4)
#define CLCD_FRAMEBUFFER 0x0F700000 //CLCD_FRAMEBUFFER 0x5F700000
#else
#define CLCD_FRAMEBUFFER 0x0F700000
#endif
